...
- [ ] Technologies/frameworks mentioned (Spring, Angular, React, Python, TypeScript, etc.)
...
tags: [orm, n-plus-one, eager-loading]
module: Briefs
symptom: "Slow page load, multiple queries in logs"
root_cause: "Missing eager loading on association"
---
```
...
**Example filtering:**
```
# Found 15 learning files, plan is about "REST API caching"

# SPAWN (likely relevant):
docs/solutions/performance-issues/n-plus-one-queries.md      # tags: [orm, eager-loading] ✓
